...
return(<div className={`square-circle rounded-full p-0 pointer-events-none transform ${isDropdownOpen ?'text-black rotate-180 bg-teal-300' :'text-white rotate-90 '}`}
> <svg
