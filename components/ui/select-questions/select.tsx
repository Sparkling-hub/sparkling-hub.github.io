...
const DisabledSelect: React.FC<{ data: IQustion }> = ({ data }) => {
  ...
  return (
    <>
      <button
        className={`w-full p-3 border rounded cursor-pointer text-lg border-none ${isOpen ? '	bg-color-primary-dark text-white rounded-t-xl lg:rounded-t-2xl' : 'lg:rounded-2xl rounded-xl bg-slate-100'}`}
