...
const Service: React.FC<IService> = ({ content, header, image, button, index }) => {
	...
	return (
		<div className={`flex-col pb-[40px] w-full lg:w-1/3 lg:px-[20px] h-full text-center 2xl:h-[700px] xl:h-[750px] lg:h-[800px] bg-white m-2 rounded-3xl ${(index)%2==0?'lg:mt-[100px]':""}`}>
