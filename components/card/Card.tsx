...
const Card: React.FC<ICard> = ({ officeCard }) => {
	
	return (

		<div className="fixed lg:absolute z-[80] text-black w-screen lg:max-w-[280px] max-lg:!left-0 max-lg:!top-auto max-lg:bottom-0 lg:bottom-auto fixed-location lg:-translate-x-full lg:-ml-3 lg:-translate-y-full lg:-mt-3 h-96" >
		<div className="lg:absolute w-full bg-primary-dark duration-[300ms] overflow-hidden bottom-full lg:ease-out lg:delay-[400ms] h-96" >
		  <div className="p-global lg:absolute w-full left-0 bottom-0 h-96 p-8">
			<button className="absolute top-5% right-5% z-10 h-4">
		...
		<div className="absolute h-[1.5px] bg-primary-dark z-10 duration-[300ms] right-0 bottom-0 w-full lg:delay-[200ms]"></div>
