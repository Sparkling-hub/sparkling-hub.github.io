						...
						<div className="mb-12"><p>See locations</p>
							<div className="flex gap-4 flex-wrap group">
								...
								{countries.map((country) => (
									<button id={country.id} className={`btn duration-200 !flex gap-2 items-center light hover:bg-primary-light-light mx-4 p-4 font-medium ${country.id == currentMap?.id ? 'bg-primary-light-light' : 'bg-primary-dark'}`}  >{country.name}
