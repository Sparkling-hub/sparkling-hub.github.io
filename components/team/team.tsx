...
const Benefit: React.FC<ITeam> = ({ content, header, index, marginRight, marginLeft }) => {
	...
	return (
		...
		<div className={`flex justify-between items-center ${marginRight} ${marginLeft} m-0`}>
			<div className={`lg:w-[80%] w-full flex flex-col  justify-center p-4 rounded-2xl relative my-3`}>
				...
				<div className='flex flex-col'>
					...
					<div className={`m-2 min-h-[60px] w-full lg:w-7/8 leading-8 rounded-3xl py-5 px-8 relative ${(index % 2) ? "bg-violet-50" : "bg-teal-50"}`}>
