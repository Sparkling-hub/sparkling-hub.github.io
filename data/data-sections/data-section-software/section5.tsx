...
const header = <h2 className="text-center text-lg m-3">Adaptability at <strong className="text-teal-500 font-bold">its best</strong></h2>
const content = <p className="text-center">
