...
const head = <div className="flex flex-col items-center mb-14 text-center font-light"><h2 className="font-5 text-5xl mb-5">Forge your <strong className="text-teal-500 font-semibold">dream team</strong>!</h2>
